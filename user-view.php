...
<head>
  ...
  <link href="css/user_view.css" rel="stylesheet" type="text/css">
  <link href="css/view_user.css" rel="stylesheet" type="text/css">
      ...
      <div class="view-content-container">
        ...
        <div class="div-block-95">
          ...
          <div class="div-block-92">
            <p class="paragraph">DESCRIPTION: <br><?php echo $query_execute['DanceDataset_Description']; ?></p>
            <div class="div-block-96"><a href="#" class="link-5">REQUEST ACCESS</a>
